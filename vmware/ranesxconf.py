...
def esxconf_multi():
    ...
    from list_esxconf import generate_host_config
...
# Then change NO_GO to false to let ranesxconf use configuration file
NO_GO = true

EMAIL_FROM = ranesxconf@yourdomain.com
EMAIL_TO = esxadmin@yourdomain.com
...
SERVER_LIST = ~/.ranesxconf_server_list.txt
"""
...
def main():
    ...
    filename = r"%s/%s" % (os.environ["HOME"], ".ranesxconf")
